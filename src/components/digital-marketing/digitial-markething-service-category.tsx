...
function ServiceCategoryItem({ icon, title, subtitle }: ServiceCategoryItemProps) {
  return (
    ...
    >
      {/* Logo */}
      <motion.div
        className="flex items-center justify-center w-12 h-12 sm:w-[67px] sm:h-[67px] md:w-[75px] md:h-[72px] rounded-full bg-white -ml-0.5 sm:-ml-1 mr-3 sm:mr-3 flex-shrink-0"
