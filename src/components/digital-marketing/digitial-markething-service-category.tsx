...
export function DigitialMarkethingServiceCategory({ services }: AnimatedServiceCategoryProps) {
...
function ServiceCategoryItem({ icon, title, subtitle }: ServiceCategoryItemProps) {
  return (
    <motion.div
      className="flex items-center justify-start w-full max-w-[252px] sm:max-w-[308px] md:max-w-[500px] px-2 sm:px-3.5 py-1 sm:py-1.75 bg-gray-600/40 rounded-full shadow-sm"
      whileHover={{
        scale: 1.08,
    ...
    >
      <motion.div
        className="flex items-center justify-center w-12 h-12 sm:w-[67px] sm:h-[67px] md:w-[75px] md:h-[72px] rounded-full bg-transparent -ml-0.5 sm:-ml-1 mr-3 sm:mr-3 flex-shrink-0"
