  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center">
        <motion.h1
          className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-2 sm:mb-3 md:mb-4 text-[#41B4A7] "
        ...
        <motion.h2
          className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-800 mb-4 md:mb-6 max-w-3xl mx-auto px-2"
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        <motion.div
          className="relative w-full py-5  mx-auto overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
