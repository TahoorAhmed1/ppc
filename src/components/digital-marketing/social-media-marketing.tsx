...
function ServiceCard({ number, title, description }: ServiceCardProps) {
  return (
    <div className="bg-gradient-to-r from-[#65CE5C]/80 to-[#209CEB] hover:from-[#209CEB]/80 hover:to-[#65CF5F] transition-all duration-300 hover:scale-105 rounded-xl p-[5px]">
      <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col h-full">      
        <div className="text-xl text-end font-medium text-emerald-500 mb-4 ">{number}</div>
