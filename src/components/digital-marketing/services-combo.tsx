  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20 font-sans">
      <div className="grid grid-cols-1 gap-8 mx-auto max-w-7xl lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 md:gap-x-8 gap-y-8 md:gap-y-10">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-[#3DB1B1] text-lg sm:text-xl font-bold mb-3 sm:mb-4">LOGO DESIGN SERVICES</h2>
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    <span className="text-[#3DB1B1] mr-2 flex-shrink-0">›</span>
              ...
              {/* STATIONARY SERVICES */}
              <div>
                <h2 className="text-[#3DB1B1] text-lg sm:text-xl font-bold mb-3 sm:mb-4">STATIONARY SERVICES</h2>
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    <span className="text-[#3DB1B1] mr-2 flex-shrink-0">›</span>
              ...
              <div>
                <h2 className="text-[#3DB1B1] text-lg sm:text-xl font-bold mb-3 sm:mb-4">SOCIAL MEDIA SERVICES</h2>
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    <span className="text-[#3DB1B1] mr-2 flex-shrink-0">›</span>
            ...
            <div className="space-y-8">
              {/* WEBSITE SERVICES */}
              <div>
                <h2 className="text-[#3DB1B1] text-lg sm:text-xl font-bold mb-3 sm:mb-4">WEBSITE SERVICES</h2>
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    <span className="text-[#3DB1B1] mr-2 flex-shrink-0">›</span>
              ...
              <div>
                <h2 className="text-[#3DB1B1] text-lg sm:text-xl font-bold mb-3 sm:mb-4">VALUE-ADDED SERVICES</h2>
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    <span className="text-[#3DB1B1] mr-2 flex-shrink-0">›</span>
                    <span className="text-sm sm:text-base">All Final File Formats</span>
        ...
        {/* Right Pricing Box */}
        <div className="bg-[#3DB1B1] rounded-lg p-5 sm:p-6 text-white flex flex-col h-fit shadow-lg mt-8 lg:mt-0">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-2">COMBO PACKAGES</h2>
          <p className="text-center mb-4 sm:mb-6 text-sm sm:text-base">Company Branding Solution</p>

          <div className="text-center mb-3 sm:mb-4">
            <div className="flex items-center justify-center">
              <span className="text-5xl sm:text-6xl font-bold">$2999</span>
              <div className="ml-2 text-left">
                <span className="line-through text-sm sm:text-base">$5000</span>
                <br />
          ...
          <button
            className="bg-white w-full sm:w-[200px] text-base sm:text-[17px] py-2.5 sm:py-2 font-medium hover:opacity-90 text-black rounded-lg border-none mx-auto shadow-2xl"
