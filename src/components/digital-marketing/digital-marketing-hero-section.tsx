...
import { AnimatedServiceCategory } from "../website-development/animated-service-category";
...
const services = [
    ...
    { icon: twitterIcon.src, title: "TWITTER X", subtitle: "MARKETING" },
    {
        icon: instagramIcon.src,
        title: "INSTAGRAM",
        subtitle: "MARKETING",
    },
    { icon: snapchatIcon.src, title: "TECHNOLOGY", subtitle: "MARKETING" },
    {
        icon: tiktokIcon.src,
        title: "TIK TOK",
        subtitle: "MARKETING",
