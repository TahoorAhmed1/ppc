    ...
    <div className="bg-gray-900 p-4 md:p-8 min-h-screen flex flex-col items-center gap-8 sm:gap-10 md:gap-14 py-10 sm:py-14 md:py-16">
      ...
      {[1, 2, 3, 4].map((pkg, idx) => (
        ...
        >
          ...
          >
            <div className="bg-white rounded-3xl p-4 sm:p-6 flex-1">
              ...
              <p className="text-gray-600 text-sm sm:text-base mb-4 sm:mb-6 max-w-sm">
                Lay the groundwork for your social media success with the
                essentials to get started. By building a strong foundation,
          ...
          {/* Right Card */}
          <div
            className={`bg-white col-span-1 md:col-span-2 rounded-3xl p-6 sm:p-8 md:p-10 flex-1 ${
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 text-sm sm:text-base">
                  ...
                  banner and a functional contact or query form. The website
                  will be developed using W3C certified HTML standards and
                  delivered within 48 to 72 hours. It also comes with complete
                  deployment support. We guarantee 100% satisfaction, a 100%
                  unique design, and offer a full money-back guarantee if
            ...
            <div className="flex flex-col gap-4 h-56 sm:h-64 md:h-80">
              <div className="relative aspect-square overflow-hidden rounded-lg">
                <Image
                  src={pricingImage || "/placeholder.svg"}
