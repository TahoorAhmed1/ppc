...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="max-w-[650px] space-y-6 col-span-1"
        ...
        >
          ...
          <div className="space-y-4 md:col-span-2 text-black">
            <h3 className="text-xl font-bold bg-gradient-to-r from-black/80 to-black text-transparent bg-clip-text">
              Contact us
            </h3>
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+18045745376">+92 3282371639</a>
            </div>
    ...
    >
      ...
      <motion.ul className="space-y-3" variants={containerVariants}>
        {links.map(({ name, link }: any, index: any) => (
          ...
          >
            <a href={`#${link}`} className="text-black hover:text-gray-900">
              {name}
            </a>
          </motion.li>
        ))}
