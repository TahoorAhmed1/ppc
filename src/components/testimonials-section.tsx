...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Their ability to turn abstract concepts into visually stunning campaigns is what sets this agency apart. They’re not just designers — they’re storytellers.",
    },
    {
      id: 7,
      ...
      content:
        "From pitch decks to brand kits, the agency delivered cohesive materials that wowed our investors. Couldn’t be more impressed.",
    },
    {
      id: 8,
      ...
      role: "UX Lead",
      content:
        "They reimagined our entire user experience with a fresh, creative eye. The results were both beautiful and functional.",
    },
  ];
