...
const awardsData = [
  ...
  },
  {
    ...
    rating: 4.9,
    className: "w-26",
    description: "Recognized as a leader in WordPress, ReactJs, and Web Design in the United States.",
  },
  {
    imageSrc: newAwardBgBlack3.src,
    className: "w-14",
    rating: 4.7,
    description: "Proud to be a BBB Accredited business, demonstrating trust and commitment to excellence.",
  },
  {
    ...
    <section className="relative container py-16 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between mb-16">
          ...
          <motion.div
            className="lg:w-1/3 hidden lg:flex justify-end mt-8 lg:-mt-10"
