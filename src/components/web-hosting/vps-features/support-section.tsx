...
export function SupportSection() {
  return (
    <div className="bg-gradient-to-r from-[#65CF5F]/80 to-[#1F9BED] text-white py-10 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 relative">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg leading-relaxed drop-shadow-sm">
              You are never alone! At Creative Agency, we provide 24/7/365 expert support
              for our VPS services via live chat, ticket, and phone support. Contact our
              support team at any time of the day and resolve any issue you might have instantly!
            </p>
          </div>
        </div>
      </div>
