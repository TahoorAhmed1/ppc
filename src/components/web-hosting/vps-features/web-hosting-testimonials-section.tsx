import { trustpilot, trustpilot2 } from "@/assets";
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
          Over 93% of our customers rate us as Excellent or Very Good. Here are
          a couple of reviews that some of them have left.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          ...
          <p className="font-medium mt-4">Gabriele and Amr</p>
        </div>
      </div>
    </div>
  );
...
function GoogleLogo() {
  return (
    <div className="flex items-center">
      <svg viewBox="0 0 272 92" width="100" height="34" className="block">
        <path
