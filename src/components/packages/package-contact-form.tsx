  ...
  return (
    ...
    >
      ...
      <div id="contactus" className="container relative z-10 ">
        <h1 className="text-4xl md:text-5xl text-center font-bold  bg-gradient-to-r from-black/80 to-black text-transparent bg-clip-text mb-15">
          Connect Our Team
        </h1>
          ...
          <motion.div variants={imageVariants}>
            <motion.div className="my-10 lg:my-0">
              <p className="text-lg text-black">
                ...
                consultations tailored to your needs. At Nexuz Global, we
