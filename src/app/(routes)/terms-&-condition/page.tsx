    ...
    <div className="min-h-screen flex flex-col ">
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 ">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 follows the &apos;Under the Data Protection
            Act.&apos; Your information will be confidential when passed on to
            third parties. It will only be accessible by the authorities for
            legal proceedings.
          </p>
          <p className="mb-3">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 offers 2 days to cancel your subscription. We
            will accept your cancellation by e-mail, message, call, or in
            person. Both parties have the right to cancel the agreement for any
            reason.
          </p>
          <p className="mb-3">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 offers a wide range of services that are
            accessible to everyone. You can use our website for particular
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            ...
            clients. The IP addresses in the log files of Creative Agency 360
            access to web servers, URLs, and system administration.
          </p>
          <p className="mb-3">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 uses cookies to collect users&apos; detail on
            every visit. The cookies enhance functionality and offer easy
            website browsing.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 does not allow users to create links to their
            pages without prior consent. Doing so without approval can put you
            at risk. In content on our website, we have limitations in various
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            All the content of Creative Agency 360 is protected according to
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            ...
            Creative Agency 360. The services of other companies on our website
            show that they are the trademarks of their respective owners, such
            as social media icons.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 uses newsletters to send e-mails and keep your
            ID safe from third parties. We also provide unsubscribe instructions
            for those who do not want newsletter subscriptions.
          </p>
          <p className="mb-3">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Creative Agency 360 has all the rights to change or upgrade its
            Terms and Conditions when needed. Your continued use of our service
            confirms that you have read and accepted the changes.
          </p>
          <p className="mb-3">
